...
namespace glm
{
	...
	struct vec<4, ComponentType, Q>
	{
		// -- Implementation detail --

		typedef ComponentType value_type;
		typedef vec<4, ComponentType, Q> type;
...
#		else
			...
			union { ComponentType z, b, p; };
			union { ComponentType w, a, q; };
...
#		endif
		...
		GLM_FUNC_DECL GLM_CONSTEXPR vec(vec<4, ComponentType, Q> const& v) GLM_DEFAULT;
		template<qualifier P>
		GLM_FUNC_DECL GLM_CONSTEXPR vec(vec<4, ComponentType, P> const& v);

		// -- Explicit basic constructors --

		GLM_FUNC_DECL GLM_CONSTEXPR explicit vec(ComponentType scalar);
		GLM_FUNC_DECL GLM_CONSTEXPR vec(ComponentType x, ComponentType y, ComponentType z, ComponentType w);
...
#		endif//GLM_CONFIG_SWIZZLE == GLM_SWIZZLE_OPERATOR
		...
		GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q>& operator=(vec<4, ComponentType, Q> const& v) GLM_DEFAULT;

		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q>& operator=(vec<4, U, Q> const& v);
		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q>& operator+=(U scalar);
		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q>& operator+=(vec<1, U, Q> const& v);
		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q>& operator+=(vec<4, U, Q> const& v);
		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q>& operator-=(U scalar);
		...
		GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> & operator++();
		GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> & operator--();
		GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> operator++(int);
		GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> operator--(int);
	...
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> operator+(vec<4, ComponentType, Q> const& v);
	...
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> operator+(vec<4, ComponentType, Q> const& v, ComponentType const & scalar);

	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> operator+(vec<4, ComponentType, Q> const& v1, vec<1, ComponentType, Q> const& v2);

	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> operator+(ComponentType scalar, vec<4, ComponentType, Q> const& v);

	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> operator+(vec<1, ComponentType, Q> const& v1, vec<4, ComponentType, Q> const& v2);

	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> operator+(vec<4, ComponentType, Q> const& v1, vec<4, ComponentType, Q> const& v2);
	...
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> operator%(vec<4, ComponentType, Q> const& v, ComponentType scalar);

	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> operator%(vec<4, ComponentType, Q> const& v, vec<1, ComponentType, Q> const& scalar);

	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> operator%(ComponentType scalar, vec<4, ComponentType, Q> const& v);

	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<4, ComponentType, Q> operator%(vec<1, ComponentType, Q> const& scalar, vec<4, ComponentType, Q> const& v);
	...
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR bool operator==(vec<4, ComponentType, Q> const& v1, vec<4, ComponentType, Q> const& v2);
