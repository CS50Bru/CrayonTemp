...
namespace glm
{
	...
	struct vec<3, ComponentType, Q>
	{
		// -- Implementation detail --

		typedef ComponentType value_type;
		typedef vec<3, ComponentType, Q> type;
...
#		endif
		...
		GLM_FUNC_DECL GLM_CONSTEXPR vec(vec<3, ComponentType, P> const& v);

		// -- Explicit basic constructors --

		GLM_FUNC_DECL GLM_CONSTEXPR explicit vec(ComponentType scalar);
		GLM_FUNC_DECL GLM_CONSTEXPR vec(ComponentType a, ComponentType b, ComponentType c);
...
#		endif//GLM_CONFIG_SWIZZLE == GLM_SWIZZLE_OPERATOR
		...
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q>& operator=(vec<3, ComponentType, Q> const& v) GLM_DEFAULT;

		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> & operator=(vec<3, U, Q> const& v);
		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> & operator+=(U scalar);
		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> & operator+=(vec<1, U, Q> const& v);
		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> & operator+=(vec<3, U, Q> const& v);
		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> & operator-=(U scalar);
		...
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> & operator++();
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> & operator--();
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> operator++(int);
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> operator--(int);
	...
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> operator+(vec<3, ComponentType, Q> const& v);
	...
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> operator+(vec<3, ComponentType, Q> const& v, ComponentType scalar);

	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> operator+(vec<3, ComponentType, Q> const& v, vec<1, ComponentType, Q> const& scalar);

	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> operator+(ComponentType scalar, vec<3, ComponentType, Q> const& v);

	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> operator+(vec<1, ComponentType, Q> const& v1, vec<3, ComponentType, Q> const& v2);

	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> operator+(vec<3, ComponentType, Q> const& v1, vec<3, ComponentType, Q> const& v2);

	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> operator-(vec<3, ComponentType, Q> const& v, ComponentType scalar);

	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> operator-(vec<3, ComponentType, Q> const& v1, vec<1, ComponentType, Q> const& v2);
	...
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, ComponentType, Q> operator&(vec<3, ComponentType, Q> const& v1, ComponentType scalar);
	...
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR bool operator==(vec<3, ComponentType, Q> const& v1, vec<3, ComponentType, Q> const& v2);
