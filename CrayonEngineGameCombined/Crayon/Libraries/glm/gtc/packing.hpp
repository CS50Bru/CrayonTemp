...
namespace glm
{
	...
	///
	/// @see gtc_packing
	/// @see vec<3, ComponentType, Q> unpackRGBM(vec<4, ComponentType, Q> const& p)
	/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification, section 8.4 Floating-Point Pack and Unpack Functions</a>
	template<length_t L, typename ComponentType, qualifier Q>
	GLM_FUNC_DECL vec<4, ComponentType, Q> packRGBM(vec<3, ComponentType, Q> const& rgb);
	...
	///
	/// @see gtc_packing
	/// @see vec<4, ComponentType, Q> packRGBM(vec<3, float, Q> const& v)
	/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification, section 8.4 Floating-Point Pack and Unpack Functions</a>
	template<length_t L, typename ComponentType, qualifier Q>
	GLM_FUNC_DECL vec<3, ComponentType, Q> unpackRGBM(vec<4, ComponentType, Q> const& rgbm);
