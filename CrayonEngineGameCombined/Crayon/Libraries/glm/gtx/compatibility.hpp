...
namespace glm
{
	...
	template<typename ComponentType> GLM_FUNC_QUALIFIER ComponentType lerp(ComponentType x, ComponentType y, ComponentType a){return mix(x, y, a);}																					//!< \brief Returns x * (1.0 - a) + y * a, i.e., the linear blend of x and y using the floating-point value a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER vec<2, ComponentType, Q> lerp(const vec<2, ComponentType, Q>& x, const vec<2, ComponentType, Q>& y, ComponentType a){return mix(x, y, a);}							//!< \brief Returns x * (1.0 - a) + y * a, i.e., the linear blend of x and y using the floating-point value a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)

	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER vec<3, ComponentType, Q> lerp(const vec<3, ComponentType, Q>& x, const vec<3, ComponentType, Q>& y, ComponentType a){return mix(x, y, a);}							//!< \brief Returns x * (1.0 - a) + y * a, i.e., the linear blend of x and y using the floating-point value a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER vec<4, ComponentType, Q> lerp(const vec<4, ComponentType, Q>& x, const vec<4, ComponentType, Q>& y, ComponentType a){return mix(x, y, a);}							//!< \brief Returns x * (1.0 - a) + y * a, i.e., the linear blend of x and y using the floating-point value a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER vec<2, ComponentType, Q> lerp(const vec<2, ComponentType, Q>& x, const vec<2, ComponentType, Q>& y, const vec<2, ComponentType, Q>& a){return mix(x, y, a);}	//!< \brief Returns the component-wise result of x * (1.0 - a) + y * a, i.e., the linear blend of x and y using vector a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER vec<3, ComponentType, Q> lerp(const vec<3, ComponentType, Q>& x, const vec<3, ComponentType, Q>& y, const vec<3, ComponentType, Q>& a){return mix(x, y, a);}	//!< \brief Returns the component-wise result of x * (1.0 - a) + y * a, i.e., the linear blend of x and y using vector a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER vec<4, ComponentType, Q> lerp(const vec<4, ComponentType, Q>& x, const vec<4, ComponentType, Q>& y, const vec<4, ComponentType, Q>& a){return mix(x, y, a);}	//!< \brief Returns the component-wise result of x * (1.0 - a) + y * a, i.e., the linear blend of x and y using vector a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)

	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER ComponentType saturate(ComponentType x){return clamp(x, ComponentType(0), ComponentType(1));}														//!< \brief Returns clamp(x, 0, 1) for each component in x. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER vec<2, ComponentType, Q> saturate(const vec<2, ComponentType, Q>& x){return clamp(x, ComponentType(0), ComponentType(1));}					//!< \brief Returns clamp(x, 0, 1) for each component in x. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER vec<3, ComponentType, Q> saturate(const vec<3, ComponentType, Q>& x){return clamp(x, ComponentType(0), ComponentType(1));}					//!< \brief Returns clamp(x, 0, 1) for each component in x. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER vec<4, ComponentType, Q> saturate(const vec<4, ComponentType, Q>& x){return clamp(x, ComponentType(0), ComponentType(1));}					//!< \brief Returns clamp(x, 0, 1) for each component in x. (From GLM_GTX_compatibility)

	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER ComponentType atan2(ComponentType x, ComponentType y){return atan(x, y);}																//!< \brief Arc tangent. Returns an angle whose tangent is y/x. The signs of x and y are used to determine what quadrant the angle is in. The range of values returned by this function is [-PI, PI]. Results are undefined if x and y are both 0. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER vec<2, ComponentType, Q> atan2(const vec<2, ComponentType, Q>& x, const vec<2, ComponentType, Q>& y){return atan(x, y);}	//!< \brief Arc tangent. Returns an angle whose tangent is y/x. The signs of x and y are used to determine what quadrant the angle is in. The range of values returned by this function is [-PI, PI]. Results are undefined if x and y are both 0. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER vec<3, ComponentType, Q> atan2(const vec<3, ComponentType, Q>& x, const vec<3, ComponentType, Q>& y){return atan(x, y);}	//!< \brief Arc tangent. Returns an angle whose tangent is y/x. The signs of x and y are used to determine what quadrant the angle is in. The range of values returned by this function is [-PI, PI]. Results are undefined if x and y are both 0. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_QUALIFIER vec<4, ComponentType, Q> atan2(const vec<4, ComponentType, Q>& x, const vec<4, ComponentType, Q>& y){return atan(x, y);}	//!< \brief Arc tangent. Returns an angle whose tangent is y/x. The signs of x and y are used to determine what quadrant the angle is in. The range of values returned by this function is [-PI, PI]. Results are undefined if x and y are both 0. (From GLM_GTX_compatibility)

	template<typename genType> GLM_FUNC_DECL bool isfinite(genType const& x);											//!< \brief Test whether or not a scalar or each vector component is a finite value. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_DECL vec<1, bool, Q> isfinite(const vec<1, ComponentType, Q>& x);				//!< \brief Test whether or not a scalar or each vector component is a finite value. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_DECL vec<2, bool, Q> isfinite(const vec<2, ComponentType, Q>& x);				//!< \brief Test whether or not a scalar or each vector component is a finite value. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_DECL vec<3, bool, Q> isfinite(const vec<3, ComponentType, Q>& x);				//!< \brief Test whether or not a scalar or each vector component is a finite value. (From GLM_GTX_compatibility)
	template<typename ComponentType, qualifier Q> GLM_FUNC_DECL vec<4, bool, Q> isfinite(const vec<4, ComponentType, Q>& x);				//!< \brief Test whether or not a scalar or each vector component is a finite value. (From GLM_GTX_compatibility)
