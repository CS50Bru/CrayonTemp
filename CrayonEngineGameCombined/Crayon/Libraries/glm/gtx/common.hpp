...
namespace glm
{
	...
	GLM_FUNC_DECL vec<L, ComponentType, Q> fmod(vec<L, ComponentType, Q> const& v);
	...
	template <length_t L, typename ComponentType, qualifier Q>
	GLM_FUNC_DECL vec<L, bool, Q> openBounded(vec<L, ComponentType, Q> const& Value, vec<L, ComponentType, Q> const& Min, vec<L, ComponentType, Q> const& Max);
	...
	/// @see ext_vector_relational
	template <length_t L, typename ComponentType, qualifier Q>
	GLM_FUNC_DECL vec<L, bool, Q> closeBounded(vec<L, ComponentType, Q> const& Value, vec<L, ComponentType, Q> const& Min, vec<L, ComponentType, Q> const& Max);
