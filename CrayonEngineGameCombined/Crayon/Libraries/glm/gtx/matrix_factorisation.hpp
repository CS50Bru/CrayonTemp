...
namespace glm
{
	...
	GLM_FUNC_DECL mat<C, R, ComponentType, Q> flipud(mat<C, R, ComponentType, Q> const& in);

	/// Flips the matrix columns right and left.
	///
	/// From GLM_GTX_matrix_factorisation extension.
	template <length_t C, length_t R, typename ComponentType, qualifier Q>
	GLM_FUNC_DECL mat<C, R, ComponentType, Q> fliplr(mat<C, R, ComponentType, Q> const& in);
	...
	/// From GLM_GTX_matrix_factorisation extension.
	template <length_t C, length_t R, typename ComponentType, qualifier Q>
	GLM_FUNC_DECL void qr_decompose(mat<C, R, ComponentType, Q> const& in, mat<(C < R ? C : R), R, ComponentType, Q>& q, mat<C, (C < R ? C : R), ComponentType, Q>& r);
	...
	/// From GLM_GTX_matrix_factorisation extension.
	template <length_t C, length_t R, typename ComponentType, qualifier Q>
	GLM_FUNC_DECL void rq_decompose(mat<C, R, ComponentType, Q> const& in, mat<(C < R ? C : R), R, ComponentType, Q>& r, mat<C, (C < R ? C : R), ComponentType, Q>& q);
