...
namespace glm
{
	...
	GLM_FUNC_DECL ComponentType normalizeDot(vec<L, ComponentType, Q> const& x, vec<L, ComponentType, Q> const& y);
	...
	/// @see gtx_normalize_dot extension.
	template<length_t L, typename ComponentType, qualifier Q>
	GLM_FUNC_DECL ComponentType fastNormalizeDot(vec<L, ComponentType, Q> const& x, vec<L, ComponentType, Q> const& y);
