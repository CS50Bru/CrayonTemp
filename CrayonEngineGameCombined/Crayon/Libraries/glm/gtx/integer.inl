...
*/
	...
	GLM_FUNC_QUALIFIER vec<2, ComponentType, Q> factorial(
	...
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_QUALIFIER vec<3, ComponentType, Q> factorial(
	...
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_QUALIFIER vec<4, ComponentType, Q> factorial(
