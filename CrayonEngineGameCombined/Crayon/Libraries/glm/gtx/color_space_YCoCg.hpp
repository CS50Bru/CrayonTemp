...
namespace glm
{
	...
	GLM_FUNC_DECL vec<3, ComponentType, Q> rgb2YCoCg(
		vec<3, ComponentType, Q> const& rgbColor);

	/// Convert a color from YCoCg color space to RGB color space.
	/// @see gtx_color_space_YCoCg
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL vec<3, ComponentType, Q> YCoCg2rgb(
	...
	/// @see gtx_color_space_YCoCg
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL vec<3, ComponentType, Q> rgb2YCoCgR(
		vec<3, ComponentType, Q> const& rgbColor);
	...
	/// @see gtx_color_space_YCoCg
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL vec<3, ComponentType, Q> YCoCgR2rgb(
		vec<3, ComponentType, Q> const& YCoCgColor);
