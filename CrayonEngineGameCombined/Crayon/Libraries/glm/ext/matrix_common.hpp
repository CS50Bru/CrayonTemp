...
namespace glm
{
	...
	GLM_FUNC_DECL mat<C, R, ComponentType, Q> mix(mat<C, R, ComponentType, Q> const& x, mat<C, R, ComponentType, Q> const& y, mat<C, R, U, Q> const& a);

	template<length_t C, length_t R, typename ComponentType, typename U, qualifier Q>
	GLM_FUNC_DECL mat<C, R, ComponentType, Q> mix(mat<C, R, ComponentType, Q> const& x, mat<C, R, ComponentType, Q> const& y, U a);
