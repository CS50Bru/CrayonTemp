...
namespace glm
{
	...
	GLM_FUNC_DECL ComponentType angle(qua<ComponentType, Q> const& x);
	...
	/// @tparam Q A value from qualifier enum
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL vec<3, ComponentType, Q> axis(qua<ComponentType, Q> const& x);
	...
	/// @tparam Q A value from qualifier enum
	template<typename ComponentType, qualifier Q>
	GLM_FUNC_DECL qua<ComponentType, Q> angleAxis(ComponentType const& angle, vec<3, ComponentType, Q> const& axis);
